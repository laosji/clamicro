window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var PALETTE = {"O":"#E8912D","D":"#C8751F","L":"#8A4A12","W":"#FFF3E0","B":"#2A2A2A","P":"#F28BAE"};
    var W = 16, H = 16;
    var PX = 6;
    var FRAMES = [{"id":"idle","grid":[".LLL........LLL.",".LOLL......LLOL.",".LOOLL....LLOOL.",".LOPOLL..LLOPOL.","LLOPPOLLLLOPPOLL","LOOOOOOOOOOOOOOL","LDOOOOOOOOOOOODL","LDOOWBOOOOWBOODL","LDOOBBOOOOBBOODL","LDOOOOOOOOOOOODL","LDOOOOOPPOOOOODL","LDOOOWWDDWWOOODL","LDOOOWWWWWWOOODL","LLDOOOOOOOOOODLL",".LLLLLLLLLLLLLL.","................"],"duration":2000},{"id":"blink","grid":[".LLL........LLL.",".LOLL......LLOL.",".LOOLL....LLOOL.",".LOPOLL..LLOPOL.","LLOPPOLLLLOPPOLL","LOOOOOOOOOOOOOOL","LDOOOOOOOOOOOODL","LDOOOOOOOOOOOODL","LDOOBBOOOOBBOODL","LDOOOOOOOOOOOODL","LDOOOOOPPOOOOODL","LDOOOWWDDWWOOODL","LDOOOWWWWWWOOODL","LLDOOOOOOOOOODLL",".LLLLLLLLLLLLLL.","................"],"duration":160},{"id":"idle","grid":[".LLL........LLL.",".LOLL......LLOL.",".LOOLL....LLOOL.",".LOPOLL..LLOPOL.","LLOPPOLLLLOPPOLL","LOOOOOOOOOOOOOOL","LDOOOOOOOOOOOODL","LDOOWBOOOOWBOODL","LDOOBBOOOOBBOODL","LDOOOOOOOOOOOODL","LDOOOOOPPOOOOODL","LDOOOWWDDWWOOODL","LDOOOWWWWWWOOODL","LLDOOOOOOOOOODLL",".LLLLLLLLLLLLLL.","................"],"duration":1800},{"id":"happy","grid":[".LLL........LLL.",".LOLL......LLOL.",".LOOLL....LLOOL.",".LOPOLL..LLOPOL.","LLOPPOLLLLOPPOLL","LOOOOOOOOOOOOOOL","LDOOOOOOOOOOOODL","LDOOBOOOOOOBOODL","LDOBOBOOOOBOBODL","LDOOOOOOOOOOOODL","LDOOOOOPPOOOOODL","LDOOOWWDDWWOOODL","LDOOOWWBBWWOOODL","LLDOOOOOOOOOODLL",".LLLLLLLLLLLLLL.","................"],"duration":240},{"id":"idle","grid":[".LLL........LLL.",".LOLL......LLOL.",".LOOLL....LLOOL.",".LOPOLL..LLOPOL.","LLOPPOLLLLOPPOLL","LOOOOOOOOOOOOOOL","LDOOOOOOOOOOOODL","LDOOWBOOOOWBOODL","LDOOBBOOOOBBOODL","LDOOOOOOOOOOOODL","LDOOOOOPPOOOOODL","LDOOOWWDDWWOOODL","LDOOOWWWWWWOOODL","LLDOOOOOOOOOODLL",".LLLLLLLLLLLLLL.","................"],"duration":1600}];
