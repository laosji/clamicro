/**
 * Build lib/client.js — the cat-face pet.
 * Pixel-art cat (dev/art.mjs) with bouncy idle animation (hop + squash) and
 * the Clamicro click-through.
...
const PX = 6; // display px per pixel (16 x 6 = 96px)
...
console.log("wrote", out, `(${client.length} chars, ${frames.length} frames)`);
